...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = 1094598177L;
    ...
    public final umc.test.domain.QMember member;

    public final umc.test.domain.QMission mission;

    public final EnumPath<umc.test.domain.enums.MissionStatus> status = createEnum("status", umc.test.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new umc.test.domain.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new umc.test.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
