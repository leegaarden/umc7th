...
public enum ErrorStatus implements BaseErrorCode {
    ...
    MEMBER_MISSION_NOT_FOUND(HttpStatus.BAD_REQUEST, "MISSION4002", "해당 멤버 미션은 존재하지 않습니다."),
    MISSION_STATUS_NOT_ONGOING(HttpStatus.BAD_REQUEST, "MISSION4002", "진행 중인 미션이 아닙니다."),

    // 페이징 관련
    INVALID_PAGE_NUMBER(HttpStatus.BAD_REQUEST, "PAGING4001", "페이지 번호는 1이상이어야 합니다.");
